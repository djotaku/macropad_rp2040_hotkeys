...
app = {                      # REQUIRED dict, must be named 'app'
    ...
    'macros' : [             # List of button macros...
        ...
        # 2nd row ----------
        (0x000000, 'Scene 1', [Keycode.CONTROL, Keycode.ALT, '1']),
        (0x000000, 'Scene 2', [Keycode.CONTROL, Keycode.ALT, '2']),
        (0x000000, 'Scene 3', [Keycode.CONTROL, Keycode.ALT, '3']),                     # Scroll down
        # 3rd row ----------
        (0x000000, 'Scene 4', [Keycode.CONTROL, Keycode.ALT, '4']),
        (0x000000, 'Scene 5', [Keycode.CONTROL, Keycode.ALT, '5']),
        (0x000000, 'Scene 6', [Keycode.CONTROL, Keycode.ALT, '6']),
